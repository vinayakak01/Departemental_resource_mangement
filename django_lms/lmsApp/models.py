...
class Students(models.Model):
    ...
    def __str__(self):
        return str(f"{self.code} - {self.first_name}{' '+self.middle_name if self.middle_name else ''} {self.last_name}")

    def name(self):
        return str(f"{self.first_name}{' '+self.middle_name if self.middle_name else ''} {self.last_name}")
